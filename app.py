...
def trainer_dashboard():
    ...
    # Fetch recent activities related to the trainer's clients
...
def control():
    ...
    clients = User.query.filter_by(role='member').order_by(User.name).all()
    return render_template('control.html', clients=clients)
